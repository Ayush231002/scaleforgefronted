      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-4 font-bold text-white tracking-wide">
            Case
            <span className="text-[#00B3C6]"> Studies</span>
          </h1>
              ...
              <div className="h-48 bg-gradient-to-br from-blue-500/20 to-purple-600/20 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-2">
                    <svg className="w-8 h-8 text-[#00B3C6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="text-center mt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              ...
              className="bg-gradient-to-r from-[#00B3C6] to-[#00B3C6] hover:from-[#00B3C6] hover:to-[#00B3C6] px-8 py-3 rounded-lg font-semibold text-white transition-all duration-200 transform hover:scale-105"
            >
              Get Started
            </button>
            <button
